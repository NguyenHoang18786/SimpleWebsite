...
<body>
  ...
  $user = "equifalumcnmkg";
  $dbpassword = "7bbc29b6da39382b5f7a0fb0aa5a4bc737cd1174714f757097fbd2a4b0b87786"; 
  $conn_string = "host=$host port=5432 dbname=$dbname user=$user password=$dbpassword";
